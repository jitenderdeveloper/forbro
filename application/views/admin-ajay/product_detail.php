            ...
            <div class="row product-page-main card-body">
                <div class="col-xl-4">
                    <div class="product-slider owl-carousel owl-theme" id="sync1">
                        <div class="item"><img src="<?=base_url();?>assets/images/pro3/2.jpg" alt="" class="blur-up lazyloaded"></div>
                        <div class="item"><img src="<?=base_url();?>assets/images/pro3/27.jpg" alt="" class="blur-up lazyloaded"></div>
                        <div class="item"><img src="<?=base_url();?>assets/images/pro3/1.jpg" alt="" class="blur-up lazyloaded"></div>
                        <div class="item"><img src="<?=base_url();?>assets/images/pro3/27.jpg" alt="" class="blur-up lazyloaded"></div>
                        <div class="item"><img src="<?=base_url();?>assets/images/pro3/2.jpg" alt="" class="blur-up lazyloaded"></div>
                        <div class="item"><img src="<?=base_url();?>assets/images/pro3/1.jpg" alt="" class="blur-up lazyloaded"></div>
                        <div class="item"><img src="<?=base_url();?>assets/images/pro3/27.jpg" alt="" class="blur-up lazyloaded"></div>
