                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="page-header-left">
                                <h3>Dashboard
                                    <small>VihuStore Admin panel</small>
                                </h3>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            ...
                            <div class="bg-secondary card-body">
                                <div class="media static-top-widget">
                                    <div class="media-body"><span class="m-0">Products</span>
                                        <h3 class="mb-0"> <span class="counter"><?= $total_product;?></span><small> Total</small></h3>
                                    </div>
                            ...
                            <div class="bg-primary card-body">
                                <div class="media static-top-widget">
                                    <div class="media-body"><span class="m-0">Orders</span>
                                        <h3 class="mb-0"> <span class="counter"><?= $total_orders;?></span><small> Total</small></h3>
                                    </div>
                                    <div class="icons-widgets">
                    ...
                    <div class="col-xl-3 col-md-6 xl-50">
                        <div class="card o-hidden widget-cards">
                            <div class="bg-warning card-body">
                                <div class="media static-top-widget">
                                    <div class="media-body"><span class="m-0">Orders</span>
                                        <h3 class="mb-0"> <span class="counter">11111</span><small> This Month</small></h3>
                                    </div>
                                    <div class="icons-widgets">
                            ...
                            <div class="bg-success card-body">
                                <div class="media static-top-widget">
                                    <div class="media-body"><span class="m-0">Total Amount</span>
                                        <h3 class="mb-0"><i class="fa fa-inr"></i> <span class="counter"><?= number_format($total_sum);?></span><small> This Month</small></h3>
                                    </div>
                                    <div class="icons-widgets">
                                ...
                                <div class="user-status table-responsive latest-order-table">
                                    <table class="table table-bordernone">
                                        ...
                                        foreach($orders as $ord)
                                        {
                                            ...
                                            {
                                        echo '<tr>
                                            <td>'.$ord->custom_order_no.'</td>
                                            <td class="digits"><i class="fa fa-inr"></i>'.number_format($ord->order_amount).'</td>';
                                            if($ord->payment_mode==1)
                                            {
                                                echo '<td class="font-primary"><b>Cash On Delivery</b></td>';
                                            }else
                                            {
                                                echo '<td class="font-success"><b>Online Payment</b></td>';
                                            }
                                            switch ($ord->order_shipped) {
                                                case '0':
                                                  $a = '<td class="font-danger"><b>Pending Transfers</b></td>';
                                                    break;
                                                     case '1':
                                                     $a = '<td class="font-warning"><b>Shipped</b></td>';
                                                    break;
                                                     case '2':
                                                      $a = '<td class="font-success"><b>Delivered</b></td>';
                                                    break;
                                        ...
                                        <td><a href="'.base_url('admin/order-details/'.$ord->order_id).'" target="_blank"><span class="badge badge-secondary">Order Details</span></a></td></tr>';
                                    }
                                }
                                    ?>
                                    ...
                                    <a href="<?= base_url('admin/all-orders');?>" class="btn btn-primary">View All Orders</a>
                                </div>
                                <div class="code-box-copy">
                                    ...
                                    <table class="table table-bordernone mb-0">
                                        ...
                                        <tr>
                                            <td class="bd-t-none u-s-tb">
                                                <div class="align-middle image-sm-size"><img class="img-radius align-top m-r-15 rounded-circle blur-up lazyloaded" src="<?= base_url();?>assets/images/dashboard/user2.jpg" alt="" data-original-title="" title="">
                                        ...
                                        <tr>
                                            <td class="bd-t-none u-s-tb">
                                                <div class="align-middle image-sm-size"><img class="img-radius align-top m-r-15 rounded-circle blur-up lazyloaded" src="<?= base_url();?>assets/images/dashboard/man.png" alt="" data-original-title="" title="">
                                                    <div class="d-inline-block">
                                        ...
                                        <tr>
                                            <td class="bd-t-none u-s-tb">
                                                <div class="align-middle image-sm-size"><img class="img-radius align-top m-r-15 rounded-circle blur-up lazyloaded" src="<?= base_url();?>assets/images/dashboard/user.png" alt="" data-original-title="" title="">
                                                    <div class="d-inline-block">
                                        ...
                                        <tr>
                                            <td class="bd-t-none u-s-tb">
                                                <div class="align-middle image-sm-size"><img class="img-radius align-top m-r-15 rounded-circle blur-up lazyloaded" src="<?= base_url();?>assets/images/dashboard/designer.jpg" alt="" data-original-title="" title="">
                                                    <div class="d-inline-block">
