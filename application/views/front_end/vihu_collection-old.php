...
<div class="offer-slider slide-1">
    <div>
        ...
        echo '<div class="media">
            <a href=""><img class="img-fluid "  src="'.base_url('assets/uploads/admin/product/').single_row('tbl_image_upload',['refrence_id'=>$l['ProductImage']],'f_name').'" alt=""></a>
    ...
    <div>
       ...
       <?php
        ...
        foreach($latest as $l1)
        {
            ...
            {
        echo '<div class="media">
            <a href=""><img class="img-fluid "  src="'.base_url('assets/uploads/admin/product/').single_row('tbl_image_upload',['refrence_id'=>$l1['ProductImage']],'f_name').'" alt=""></a>
            <div class="media-body align-self-center">
...
<div class="collection-product-wrapper">
    ...
    <div class="product-wrapper-grid">
        <div class="row">
            ...
            {
                echo '<h2 style="padding-left:100px; padding-top:20px;">No product found...</h2>';
            }
            else
            {
            $i=0;
            ...
            ?>
            <a href="<?= base_url('product-detail/'.url_title($res['ProductName'],'-',true).'/'.$res['hexa_id']);?>" target="_blank"></a>
                    ...
                    <div class="product-box">
                        <div class="product-imgbox">
                            <div class="product-front">
                                ...
                                <img src="<?= base_url('assets/uploads/admin/product/').$img_res;?>" class="img-fluid" alt="product">
                            </div>
                        ...
                        <div class="product-detail detail-center ">
                            ...
                            <div class="icon-detail">
                                ...
                                {
                                 echo '<button class="addCart" data-pid="'. $res['hexa_id'].'" data-pname="'.$res['ProductName'].'" data-price="'.$res['Productsaleprice'].'" title="Add to cart">';
                             }
                             else
                             {
