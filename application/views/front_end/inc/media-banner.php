...
<section class=" ratio_square pt-5">
                ...
                <div>
                  <div class="media-banner media-banner-1 border-0">
                    <div class="media-banner-box">
                      <div class="media">
                        <img src="<?= base_url();?>assets/images/layout-2/media-banner/1.jpg" class="img-fluid " alt="banner">
                    ...
                    <div class="media-banner-box">
                      <div class="media">
                        <img src="<?= base_url();?>assets/images/layout-2/media-banner/2.jpg" class="img-fluid " alt="banner">
                        <div class="media-body">
                          <div class="media-contant">
                            <div>
                              <div class="rating">
                    ...
                    <div class="media-banner-box">
                      <div class="media">
                        <img src="<?= base_url();?>assets/images/layout-2/media-banner/3.jpg" class="img-fluid " alt="banner">
                        <div class="media-body">
                          <div class="media-contant">
                            <div>
                              <div class="rating">
