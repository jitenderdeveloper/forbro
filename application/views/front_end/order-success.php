            ...
            <div class="col-lg-6">
                <div class="product-order">
                    ...
                    <div class="row product-order-detail">
                        <div class="col-3"><img src="<?= base_url();?>assets/images/layout-4/product/1.jpg" alt="" class="img-fluid "></div>
                    ...
                    <div class="row product-order-detail">
                        <div class="col-3"><img src="<?= base_url();?>assets/images/layout-4/product/2.jpg" alt="" class="img-fluid "></div>
                        <div class="col-3 order_detail">
                            <div>
                                <h4>product name</h4>
                                <h5>cotton shirt</h5></div>
